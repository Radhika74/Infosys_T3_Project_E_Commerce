...
@playground_bp.errorhandler(CSRFError)
...
def profile():
    ...
    return render_template("playground.html", items = products)



@playground_bp.route('/cart')
...
@playground_bp.route('/view-products')
...
@playground_bp.route('/media/<path:filename>')
...
@playground_bp.route('/add-product', methods = ['GET','POST'])
# @csrf.exempt
def add_products():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            return redirect("/playground/add-product")
...
@playground_bp.route("/clear-products-table")
def clear_table():
    table = Product()
...
@playground_bp.route("/delete-item/<id>", methods= ['GET','POST'] )
...
def delete_item(id):
    ...
    try:
        ...
        return redirect('/playground/view-products')
    except Exception as e:
...
@playground_bp.route("/update-item/<id>", methods= ['GET','POST'] )
